...
| R3c | **Rollback/baseline klasörleri diskte duruyor** (`<ROLLBACK_ROOT>` altında dört kopya, ~500 MB) | Düşük | v4.1 yayını ve canlı updater doğrulaması bitti; temizlik **açık onayla** yapılacak |
