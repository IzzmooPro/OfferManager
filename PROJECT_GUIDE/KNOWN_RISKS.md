...
| No | Risk | Durum |
|---|---|---|
| R12a | Frozen modda R11 yollarının kanıtı. **Yol A (Yardım → Sorun veya Öneri Bildir → Panoya Kopyala) 2026-08-02'de PAKETLİ EXE üzerinde GEÇTİ**: gerçek fare tıklaması, gerçek Windows panosu ölçümü, açıklama zorunluluğu, sızıntı yok. **Yol B (teknik hata kutusu → 'Hata Raporla') hâlâ doğrulanmadı**: giriş düğmesi adsız ikon buton olduğu için UIA'da görünmüyor. | **KISMEN KAPALI** — Yol A kapandı; Yol B açık, Aşama 2'de kurulu uygulamada tekrar denenecek |
