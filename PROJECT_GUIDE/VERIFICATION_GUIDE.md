...
**Release süreç kapısı — YEŞİL ADAY:** Exact `35f23ac` build sonrasında yalnız izinli kanıt yolları güncellendi. Artifact kimlikleri, hedefli B ve tam C manifestte aynı artifact setine bağlandı; `release_candidate_ready=true`. Tag ve GitHub Release henüz oluşturulmadı.
